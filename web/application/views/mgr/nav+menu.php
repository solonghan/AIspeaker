    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-right">
            <ul class="nav navbar-nav">
                <li>
                    <a href="<?='https://anbon.works/going/home/' ?>" target="_blank"><div class="riot" style="padding-left: 0;"><i class="fa fa-fw fa-bolt"></i>觀看前台</div></a>
                </li>
                        ...
                        <li class="menu-dropdown<?=($active==$func)?' active':"" ?>">
                            ...
                            <? if (count($obj['sub_menu']) > 0): ?>
                                ...
                                <li<?=(isset($sub_active) && $sub_active == $sub_func)?' class="active"':'' ?>>
                                    ...
                                    <i class="fa fa-fw <?= isset($sub_obj[1])?$sub_obj[1]:'' ?>"></i> <?=$sub_obj['name'] ?>
